...
class FloorplanSVG(Dataset):
    def __init__(self, data_folder, data_file, is_transform=True,
        ...
        imgPle = Image.open("E:\code\CubiCasa5k\icon.png")
        self.palette = imgPle.getpalette()
        self.palette[50 * 3: 50 * 3 + 3] = [255, 255, 255]
        self.palette[35 * 3: 35 * 3 + 3] = [160, 160, 160]
...
if __name__ == "__main__":
    ...
    d = FloorplanSVG(
        data_folder="E:\\code\\floor_data\\cubicasa5k",
        data_file='\\train.txt',
        is_transform=False
    )
